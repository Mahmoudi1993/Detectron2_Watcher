...
flags.DEFINE_integer('model_resolution', 1280, 'class_id number to')
flags.DEFINE_string('model', 'yolov8x.pt', 'pretrain model')
flags.DEFINE_string('output_format', 'XVID', 'codec used in VideoWriter when saving video to file')
flags.DEFINE_float('confidence_threshold', 0.3, 'score threshold')
flags.DEFINE_float('iou_threshold', 0.5, 'score threshold')
