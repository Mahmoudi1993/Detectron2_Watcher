...
def main(argv):
    ...
    The detection rectangle is [(w/7,690),(1000,740)], It changes according to the input.
    ...
    detection_box = [50, 300,int(width/1.5),340]
    ...
    while(cap.isOpened()):
        ...
        frame = cv2.putText(frame,'Counts = ' + str(sum(lane_count)),(145, 100),font,fontSize,black,thickness)
        frame = cv2.putText(frame,'L1=' + str(int(lane_count[0])),(160, 150),font,0.75 ,black,thickness)
        frame = cv2.putText(frame,'L2=' + str(int(lane_count[1])),(260, 150),font,0.75,black,thickness)
        frame = cv2.putText(frame,'L3=' + str(int(lane_count[2])),(360, 150),font,0.75,black,thickness)

        frame = cv2.putText(frame,'car',(650, 80),font,0.75,black,thickness)
        frame = cv2.putText(frame,str(int(objects_count['car'])),((850, 80)),font,0.75,black,thickness)
        frame = cv2.putText(frame,'truck',(650, 110),font,0.75,black,thickness)
        frame = cv2.putText(frame,str(int(objects_count['truck'])),(850, 110),font,0.75,black,thickness)
        frame = cv2.putText(frame,'motorbike',(650, 140),font,0.75,black,thickness)
        frame = cv2.putText(frame,str(int(objects_count['motor'])),((850, 140)),font,0.75,black,thickness)
